        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="modern admin logo" src="https://db.expand.ps/uploads/16232479351317.png">
      ...
      <div class="navbar-container container center-layout">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            <li class="nav-item d-none d-md-block"><a id="nav_hover" class="nav-link nav-menu-main hidden-xs" href="#"><i class="ft-menu"></i></a></li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="../../../app-assets/images/portrait/small/avatar-s-19.png" alt=" {{auth('admin') -> user() -> name}}"><i></i></span>
              </a>
 ...
 -->  <!--               <a class="dropdown-item" href="#"><i class="ft-mail"></i> My Inbox</a>
  ...
  <a class="dropdown-item" href="{{route('admin.logout')}}"><i class="ft-power"></i> 
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ft-mail"></i>
